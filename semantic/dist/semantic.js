...
$.fn.calendar.settings = {
  ...
  className: {
    ...
    column: 'column',
    table: 'ui celled centered aligned unstackable table',
    prev: 'prev link',
    next: 'next link',
        ...
        set: {
          position: function(position, calculations) {
            ...
            if(module.should.centerArrow(calculations)) {
              module.verbose('Adjusting offset to centered arrow on small target element');
...
$.fn.popup.settings = {
  ...
  // number of pixels from edge of popup to pointing arrow centered (used from centering)
  ...
  className   : {
    ...
    loading      : 'loading',
    popup        : 'ui popup',
    position     : 'top left centered bottom right',
    visible      : 'visible',
